  ...
  try {
    ...
    try {
      ...
      if (stripeError.type === 'StripeInvalidRequestError' && 
        ...
        console.log(`Customer ${customerId} doesn't exist in Stripe, cleaning up and retrying...`);
        ...
        console.log(`Created checkout session ${session.id} for new customer ${newCustomer.id}`);
      } else {
        throw stripeError;
      }
    }
